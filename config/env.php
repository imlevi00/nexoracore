 ...
 * ------------------------------------------------------------------------- */
if (KASHER_IS_LOCAL) {
    /* ===== ژینگەی لۆکاڵ (XAMPP / Windows) ===== */
    $localDbHost = kasher_secret('local_db_host', 'DB_HOST', '127.0.0.1');
    $localDbPort = kasher_secret('local_db_port', 'DB_PORT', '3306');
    $localDbUser = kasher_secret('local_db_username', 'DB_USERNAME', 'itsmelevi');
    $localDbPassword = kasher_secret('local_db_password', 'DB_PASSWORD', 'levi12345');
    ...
    if (!defined('KASHER_PLATFORM_DB_USERNAME')) define('KASHER_PLATFORM_DB_USERNAME', $localDbUser);
    if (!defined('KASHER_PLATFORM_DB_PASSWORD')) define('KASHER_PLATFORM_DB_PASSWORD', $localDbPassword);
    ...
    if (!defined('ZANYARI_DB_USERNAME')) define('ZANYARI_DB_USERNAME', $localDbUser);
    if (!defined('ZANYARI_DB_PASSWORD')) define('ZANYARI_DB_PASSWORD', $localDbPassword);
    ...
    if (!defined('KASHER_LOGS_DB_USERNAME')) define('KASHER_LOGS_DB_USERNAME', $localDbUser);
    if (!defined('KASHER_LOGS_DB_PASSWORD')) define('KASHER_LOGS_DB_PASSWORD', $localDbPassword);
    ...
    if (!defined('IMAGES_DB_USERNAME')) define('IMAGES_DB_USERNAME', $localDbUser);
    if (!defined('IMAGES_DB_PASSWORD')) define('IMAGES_DB_PASSWORD', $localDbPassword);
    ...
    // -- kasher_media (ڤیدیۆکان) --
    if (!defined('VIDEOS_DB_HOST'))     define('VIDEOS_DB_HOST', $localDbHost);
    if (!defined('VIDEOS_DB_USERNAME')) define('VIDEOS_DB_USERNAME', $localDbUser);
    if (!defined('VIDEOS_DB_PASSWORD')) define('VIDEOS_DB_PASSWORD', $localDbPassword);
    ...
    if (!defined('KASHER_PLATFORM_DB_USERNAME')) define('KASHER_PLATFORM_DB_USERNAME', 'itsmelevi');
    if (!defined('KASHER_PLATFORM_DB_PASSWORD')) define('KASHER_PLATFORM_DB_PASSWORD', 'levi12345');
    if (!defined('KASHER_PLATFORM_DB_NAME'))     define('KASHER_PLATFORM_DB_NAME', 'nexoracore_db');
    if (!defined('KASHER_PLATFORM_DB_CHARSET'))  define('KASHER_PLATFORM_DB_CHARSET', 'utf8mb4');

    // -- kasher_zanyari (kasher_z) --
    if (!defined('ZANYARI_DB_HOST'))     define('ZANYARI_DB_HOST', 'localhost');
    if (!defined('ZANYARI_DB_USERNAME')) define('ZANYARI_DB_USERNAME', 'itsmelevi');
    if (!defined('ZANYARI_DB_PASSWORD')) define('ZANYARI_DB_PASSWORD', 'levi12345');
    if (!defined('ZANYARI_DB_NAME'))     define('ZANYARI_DB_NAME', 'nexoracore_db');
    if (!defined('ZANYARI_DB_CHARSET'))  define('ZANYARI_DB_CHARSET', 'utf8mb4');

    // -- kasher_logs --
    if (!defined('KASHER_LOGS_DB_HOST'))     define('KASHER_LOGS_DB_HOST', 'localhost');
    if (!defined('KASHER_LOGS_DB_USERNAME')) define('KASHER_LOGS_DB_USERNAME', 'itsmelevi');
    if (!defined('KASHER_LOGS_DB_PASSWORD')) define('KASHER_LOGS_DB_PASSWORD', 'levi12345');
    if (!defined('KASHER_LOGS_DB_NAME'))     define('KASHER_LOGS_DB_NAME', 'nexoracore_db');
    if (!defined('KASHER_LOGS_DB_CHARSET'))  define('KASHER_LOGS_DB_CHARSET', 'utf8mb4');

    // -- kasher_media (وێنەکان) --
    if (!defined('IMAGES_DB_HOST'))     define('IMAGES_DB_HOST', 'localhost');
    if (!defined('IMAGES_DB_USERNAME')) define('IMAGES_DB_USERNAME', 'itsmelevi');
    if (!defined('IMAGES_DB_PASSWORD')) define('IMAGES_DB_PASSWORD', 'levi12345');
    if (!defined('IMAGES_DB_NAME'))     define('IMAGES_DB_NAME', 'nexoracore_db');
    if (!defined('IMAGES_DB_CHARSET'))  define('IMAGES_DB_CHARSET', 'utf8mb4');

    // -- kasher_media (ڤیدیۆکان) --
    if (!defined('VIDEOS_DB_HOST'))     define('VIDEOS_DB_HOST', 'localhost');
    if (!defined('VIDEOS_DB_USERNAME')) define('VIDEOS_DB_USERNAME', 'itsmelevi');
    if (!defined('VIDEOS_DB_PASSWORD')) define('VIDEOS_DB_PASSWORD', 'levi12345');
    if (!defined('VIDEOS_DB_NAME'))     define('VIDEOS_DB_NAME', 'nexoracore_db');
    if (!defined('VIDEOS_DB_CHARSET'))  define('VIDEOS_DB_CHARSET', 'utf8mb4');
}

/* ---------------------------------------------------------------------------
 * ٤) URL ـی سایت — خۆکارانە بەپێی Host / IP و Path
 * ------------------------------------------------------------------------- */
if (!defined('SITE_URL')) {
    $scheme = (!empty($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) !== 'off') ? 'https' : 'http';
    $host   = $_SERVER['HTTP_HOST'] ?? '169.58.215.11';
    ...
    if ($base === '' || $base === false) {
        $base = '/Ka.sheryAi'; // fallback
    }

    $trimmedBase = trim((string)$base, '/');
    $path = $trimmedBase !== '' ? '/' . $trimmedBase . '/' : '/';
    define('SITE_URL', $scheme . '://' . $host . $path);
}
