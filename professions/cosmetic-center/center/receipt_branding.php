...
if (!$account) {
    ...
    redirect(url('professions/cosmetic-center/center/dashboard/index.php'));
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>ڕێکخستنی وەسڵ - سەنتەر</title>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(135deg, #db2777, #be185d);">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo url('professions/cosmetic-center/center/dashboard/index.php'); ?>">گەڕانەوە بۆ داشبۆرد</a>
    </div>
</nav>
<div class="container py-4">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            ...
            <form method="post" action="<?php echo url('professions/cosmetic-center/center/receipt_branding_save.php'); ?>">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            ...
            <?php endif; ?>
            <form method="post" action="<?php echo url('professions/cosmetic-center/center/receipt_branding_save.php'); ?>" enctype="multipart/form-data" class="row g-2 align-items-end">
                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            <a class="btn btn-sm btn-outline-secondary me-2" target="_blank" rel="noopener" href="<?php echo url('professions/cosmetic-center/center/receipt_a4.php?preview=1'); ?>">A4</a>
            <a class="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener" href="<?php echo url('professions/cosmetic-center/center/receipt_thermal.php?preview=1'); ?>">٨٠مم</a>
        </div>
    </div>
</div>
</body>
