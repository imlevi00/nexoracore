    ...
    if (!Security::validateCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        if ($stmt) {
            ...
            if ($row && password_verify($password, (string)$row['password_hash'])) {
                ...
                setCosmeticCenterSession([
                    'center_account_id' => (int)$row['id'],
        ...
        $error = 'ناسێنەر یان پاسۆرد هەڵەیە';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>چوونەژوورەوەی سەنتەری جوانکاری - <?php echo SITE_NAME; ?></title>
            ...
            <div class="card shadow-lg border-0 secretary-card">
                <div class="card-body p-4 p-md-5">
                    <div class="text-center mb-4">
                        <div class="secretary-icon mb-3"><i class="bi bi-building"></i></div>
                        <h4 class="mb-1">سەنتەری جوانکاری</h4>
                        <p class="text-body-secondary mb-0">چوونەژوورەوە</p>
                    </div>
                    <?php if ($error !== ''): ?>
                    ...
                    <form method="post" novalidate>
                        ...
                        <div class="mb-3">
                            <label class="form-label">ئیمەیڵ یان مۆبایل</label>
