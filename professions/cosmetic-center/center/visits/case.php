...
<nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(135deg, #db2777, #be185d);">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo url('professions/cosmetic-center/center/visits/index.php'); ?>"><i class="bi bi-arrow-right"></i> لیست</a>
...
<div class="container py-4">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            ...
            <form method="post" action="<?php echo url('professions/cosmetic-center/center/visits/save.php'); ?>" class="row g-3">
        ...
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <form method="post" action="<?php echo url('professions/cosmetic-center/center/visits/session_save.php'); ?>" class="row g-2">
                            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken, ENT_QUOTES, 'UTF-8'); ?>">
                        ...
                        <table class="table table-sm align-middle mb-0">
                            ...
                            <?php else: foreach ($sessions as $s): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a target="_blank" rel="noopener" class="btn btn-sm btn-outline-secondary py-0" href="<?php echo url('professions/cosmetic-center/center/receipt_a4.php?case_id=' . $caseId . '&session_id=' . (int)$s['id']); ?>">A4</a>
                                        <a target="_blank" rel="noopener" class="btn btn-sm btn-outline-secondary py-0" href="<?php echo url('professions/cosmetic-center/center/receipt_thermal.php?case_id=' . $caseId . '&session_id=' . (int)$s['id']); ?>">٨٠مم</a>
                                    </td>
                                </tr>
