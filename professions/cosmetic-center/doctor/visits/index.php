...
<head>
    ...
    <title>تۆمارەکان - دکتۆری جوانکاری - <?php echo SITE_NAME; ?></title>
...
<nav class="navbar navbar-expand-lg navbar-dark cosmetic-navbar">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo url('professions/cosmetic-center/doctor/dashboard/index.php'); ?>"><i class="bi bi-arrow-right-circle"></i> داشبۆرد</a>
        <div class="navbar-nav ms-auto">
            <a class="nav-link text-white" href="<?php echo url('professions/cosmetic-center/doctor/auth/logout.php'); ?>">چوونەدەرەوە</a>
        </div>
    </div>
</nav>
...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        ...
        <a href="<?php echo url('professions/cosmetic-center/doctor/visits/new.php'); ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> کەیسی نوێ</a>
    </div>
                ...
                <table class="table table-sm align-middle">
                    ...
                    <?php else: foreach ($rows as $r): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="<?php echo url('professions/cosmetic-center/doctor/visits/case.php?id=' . $sid); ?>" class="btn btn-sm btn-outline-primary">وردەکاری</a>
                                <form method="post" action="<?php echo url('professions/cosmetic-center/doctor/visits/delete.php'); ?>" class="d-inline" onsubmit="return confirm('دڵنیایت؟');">
