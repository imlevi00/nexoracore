...
<head>
    ...
    <title>دکتۆری جوانکاری - داشبۆرد - <?php echo SITE_NAME; ?></title>
    ...
    <link href="<?php echo asset('css/medical_center/cosmetic.css'); ?>" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-dark cosmetic-navbar">
    ...
    <div class="container-fluid">
        ...
        <span class="navbar-brand"><i class="bi bi-flower2"></i> دکتۆری جوانکاری</span>

        <div class="navbar-nav ms-auto">

            <a class="nav-link text-white" href="<?php echo url('professions/cosmetic-center/doctor/auth/logout.php'); ?>"><i class="bi bi-box-arrow-right"></i> چوونەدەرەوە</a>
...
<div class="container py-4">
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <p class="text-body-secondary mb-0">تۆماری کڕیار و جەلسەکان — هاوبەش لەگەڵ ئەکاونتی سەنتەر</p>
        ...
        <div class="col-12 col-md-4">
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body py-3">
                    ...
                    <div class="text-body-secondary small">کۆی نرخی کەیسەکان</div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-md-6">
            ...
            <a href="<?php echo url('professions/cosmetic-center/doctor/visits/index.php'); ?>" class="text-decoration-none">

                <div class="card border-0 shadow-sm secretary-panel h-100">

                    <div class="card-body p-4">

                        <div class="fs-2 mb-3 text-primary"><i class="bi bi-journal-medical"></i></div>
        ...
        <div class="col-12 col-md-6">
            <a href="<?php echo url('professions/cosmetic-center/doctor/receipt_branding.php'); ?>" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="fs-2 mb-3 text-primary"><i class="bi bi-image"></i></div>
        ...
        <div class="card-body">
            ...
            <form method="get" class="row g-2 mb-3">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="q" class="form-control" placeholder="گەڕان..." value="<?php echo htmlspecialchars($q, ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <?php else: foreach ($records as $r): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo url('professions/cosmetic-center/doctor/visits/case.php?id=' . $sid); ?>" class="text-decoration-none"><?php echo htmlspecialchars((string)$r['client_name'], ENT_QUOTES, 'UTF-8'); ?></a>
                            ...
                            <td>
                                ...
                                <?php if ($lastSessionId > 0): ?>
                                    ...
                                    <a target="_blank" rel="noopener" class="btn btn-sm btn-outline-secondary py-0" href="<?php echo url('professions/cosmetic-center/doctor/receipt_a4.php?case_id=' . $sid . '&session_id=' . $lastSessionId); ?>">A4</a>

                                    <a target="_blank" rel="noopener" class="btn btn-sm btn-outline-secondary py-0" href="<?php echo url('professions/cosmetic-center/doctor/receipt_thermal.php?case_id=' . $sid . '&session_id=' . $lastSessionId); ?>">٨٠مم</a>
