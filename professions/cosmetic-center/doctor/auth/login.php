    ...
    if (!Security::validateCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        if ($stmt) {
            ...
            if ($row && password_verify($password, (string)$row['password_hash'])) {
                ...
                setCosmeticDoctorSession([
                    'doctor_account_id' => (int)$row['id'],
...
<head>
    ...
    <title>چوونەژوورەوەی دکتۆری جوانکاری - <?php echo SITE_NAME; ?></title>
            ...
            <div class="card shadow-lg border-0 secretary-card">
                <div class="card-body p-4 p-md-5">
                    <div class="text-center mb-4">
                        <div class="secretary-icon mb-3"><i class="bi bi-heart-pulse"></i></div>
                        <h4 class="mb-1">دکتۆری جوانکاری</h4>
