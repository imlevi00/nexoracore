...
<head>
    ...
    <title>چوونەژوورەوەی دکتۆر - <?php echo SITE_NAME; ?></title>
            ...
            <div class="card shadow-lg border-0 secretary-card">
                <div class="card-body p-4 p-md-5">
                    <div class="text-center mb-4">
                        <div class="secretary-icon mb-3"><i class="bi bi-person-badge"></i></div>
                        <h4 class="mb-1">چوونەژوورەوەی دکتۆر</h4>
