 ...
 */
function isExpensesModuleEnabledForCurrentPackage(): bool {
 ...
 */
function canCurrentUserAccessExpensesModule($context = []): bool {
 ...
 */
function ensureExpensesSchemaTables(?mysqli $conn = null): void
