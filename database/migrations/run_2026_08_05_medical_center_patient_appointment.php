<?php
/**
 * Runner for 2026_08_05_medical_center_patient_appointment.sql (database: kasher_platform).
 * Usage:  php database/migrations/run_2026_08_05_medical_center_patient_appointment.php
 */
...
$sql = file_get_contents(__DIR__ . '/2026_08_05_medical_center_patient_appointment.sql');
