<?php
/**
 * Runner for 2026_08_03_medical_prescription_clinical_notes.sql (database: kasher_platform).
 * Usage:  php database/migrations/run_2026_08_03_medical_prescription_clinical_notes.php
 */
...
$sql = file_get_contents(__DIR__ . '/2026_08_03_medical_prescription_clinical_notes.sql');
